      ...
      <Container>
        <div className="header__wrapper" id="header-wrapper">
          <Link className="logo" to="#">
            <StaticImage className="logo__img" loading="eager" layout="fixed" placeholder="blurred" src={'../../../static/images/logo/logo-51x60.png'} alt="Logo" />
          </Link>
          ...
          <div className="header__phone-wrapper">
            <a className="header__phone-link" href={`tel:${data.phone}`}>
              <div className="header__phone-number">
                <svg className="header__phone-icon" width="25" height="24" viewBox="0 0 25 24" fill="#FFC962" xmlns="http://www.w3.org/2000/svg">
