          ...
          <ul className="footer__row">
            ...
            <li className="footer__column">
              ...
              <ul className="footer__link-list">
                ...
                <li className="footer__link-item">
                  <a className="footer__link" target="_blank" href='https://telegram.me/rozetka54'>
            ...
            <li className="footer__column">
              ...
              <ul className="footer__link-list">
                ...
                <li className="footer__link-item">
                  <a className="footer__address" href={"https://2gis.ru/novosibirsk/geo/70000001062193144"} target="_blank">
